...
document.addEventListener('DOMContentLoaded', function () {
    fetch('https://api.pioneerrocketry.com/calendar/get_all', {
        ...
        .then(() => {
            $('#calendar > div.fc-header-toolbar.fc-toolbar > div:nth-child(2)').append($('<button>').attr({ id: 'createEventBtn', type: 'button', class: 'btn btn-primary', 'data-bs-toggle': 'modal', 'data-bs-target': '#createEventModal' }).text('Create New Event'));
        })
        .catch((error) => {
